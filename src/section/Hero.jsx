...
const Hero = () => {
return (
    <section className="relative pt-72 pb-40 max-lg:pt-20 max-lg:pb-36 max-md:pt-40 max-md:pb-32 ">
        <Element name="hero">
            <div className="container relative flex flex-row max-md:flex-col">
                <div className="relative z-10 max-w-512 max-lg:max-w-388 flex-1">
                    <div className="caption small-3 uppercase text-p3">
                        All your social conversations. One powerful dashboard.
                    </div>
                    <h1 className="mb-6 h text-p4 uppercase max-lg:mb-7 max-lg:h2 max-md:mb-4 max-md:text-5xl max-md:leading-12">
                ...
                <div className="hidden md:flex absolute top-1/2 right-0 transform -translate-y-1/2 translate-x-0 w-[600px] lg:w-[900px] pointer-events-none hero-img_res justify-end items-center z-0">
                    <img
